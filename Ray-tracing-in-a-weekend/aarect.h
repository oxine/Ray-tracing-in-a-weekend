...
public:
	...
	virtual bool bounding_box(float t0, float t1, aabb& output_box) const {
		output_box = aabb(vec3(x0, y0, k - 0.01), vec3(x1, y1, k + 0.01));
		return true;
	}
...
public:
	...
	virtual bool bounding_box(float t0, float t1, aabb& output_box) const {
		output_box = aabb(vec3(x0, k - 0.01, z0), vec3(x1, k + 0.01, z1));
		return true;
	}
...
public:
	...
	virtual bool bounding_box(float t0, float t1, aabb& output_box) const {
		output_box = aabb(vec3(k - 0.01, y0, z0), vec3(k + 0.01, y1, z1));
		return true;
	}
